package com.lypt.project.ui.ac.lyyh.adapter;
...
public class LYYHAdapter extends SuperAdapter<LYYHBean> {


    private Context context;

    public LYYHAdapter(Context context, List<LYYHBean> list, int layoutResId) {
    ...
    @Override
    public void onBind(SuperViewHolder holder, int viewType, int layoutPosition, LYYHBean data) {
...
//        holder.setPaintFlag(R.id.mpgm_item_yj);
        ...
        holder.setVisibility(R.id.ll_yj,View.GONE);
