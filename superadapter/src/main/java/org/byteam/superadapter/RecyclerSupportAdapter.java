...
abstract class RecyclerSupportAdapter<T> extends RecyclerView.Adapter<SuperViewHolder>
    ...
    private OnItemDataClickListener<T> mOnItemDataClickListener;
    ...
    public void setOnItemDataClickListener(OnItemDataClickListener<T> onItemClickListener) {
        this.mOnItemDataClickListener = onItemClickListener;
    }
        ...
        if (!(holder.itemView instanceof AdapterView) && !(holder.itemView instanceof RecyclerView)) {
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    {
                        mOnItemDataClickListener.onItemClick(v,viewType,holder.getAdapterPosition(),mData);
                    }
                }
            });
